...
/* ACER Bright Lee, 2010/5/17, A41.F-1075, change the PID/VID for Acer { */
#ifdef USB_VENDOR_VID
#define MULTI_VENDOR_NUM	USB_VENDOR_VID /* XXX NetChip */
#else
#define MULTI_VENDOR_NUM	0x0525	/* XXX NetChip */
#endif

#ifdef USB_GMULTI_PID
#define MULTI_PRODUCT_NUM	USB_GMULTI_PID /* XXX */
#else
...
static struct usb_configuration rndis_config_driver = {
	.label			= "Multifunction Composite (RNDIS + ACM)",
