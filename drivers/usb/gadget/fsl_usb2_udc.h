...
struct usb_dr_device {
	...
	u8 res6[8];
	u32 ulpiviewport;	/* ULPI Viewport */
	u8 res6_1[12];
#else
	u8 res6[24];
#endif
...
#define  PORTSCX_PTC_FORCE_EN_HS              0x00050000
#define  PORTSCX_PTC_FORCE_EN_FS              0x00060000
#define  PORTSCX_PTC_FORCE_EN_LS              0x00070000
...
#define USB_STOP	1
#define USB_START	2
#define USB_SUSPEND	4
#define USB_RESUME	8

struct fsl_work_list {
...
struct fsl_udc {
	...
	unsigned usb_cable_plugged:1; 
	unsigned powered:1;
	unsigned clocked:1;
	unsigned allow_suspend_irq:1;
	...
	struct usb_platform_data * pnx_usb_data;
	int usb_need_clock_irq;
	struct timer_list	usb_vbus_timer;
	struct timer_list	usb_freedma_timer;
	struct kobject * pkobj;
	struct list_head td_tofree_list;
	struct fsl_work_list work_list;
