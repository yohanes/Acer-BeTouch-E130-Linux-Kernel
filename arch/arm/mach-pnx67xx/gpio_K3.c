/*
 *  linux/arch/arm/mach-pnx67xx/gpio_K3.c
 *
...
{
 {
    ...
    ( GPIO_MODE_MUX0 << (2 * (GPIO_A12 & 0xF)))| /* GPIOA12 -        IO_INT                                  */
 ...
 },
 {
    ...
    ( GPIO_MODE_MUX0 << (2 * (GPIO_A24 & 0xF)))| /* GPIOA24 -        WLAN_SPI_RESETN                         */
    ( GPIO_MODE_MUX0 << (2 * (GPIO_A25 & 0xF)))| /* GPIOA25 -        TAC_IRQ                                 */
    ...
    ( GPIO_MODE_MUX1 << (2 * (GPIO_A29 & 0xF)))| /* DISSD1 -         NC                                      */
 ...
 },
 {
    ...
    ( GPIO_MODE_MUX1 << (2 * (GPIO_B4  & 0xF)))| /* GPIOB4 -         NC                                      */
 ...
 },
 {
    ...
    ( GPIO_MODE_MUX1 << (2 * (GPIO_D18 & 0xF)))| /* GPIOD18 -        WLAN_HOST_WAKE                          */
    ( GPIO_MODE_MUX1 << (2 * (GPIO_D19 & 0xF)))| /* GPIOD19 -        BT_HOST_WAKE                            */
...
#if (defined ACER_K3_PR1)
    ( GPIO_MODE_MUX1 << (2 * (GPIO_D21 & 0xF)))| /* GPIOD21 -        LED_CTRL1                               */
#elif (defined ACER_K3_PR2)
    ( GPIO_MODE_MUX1 << (2 * (GPIO_D21 & 0xF)))| /* GPIOD21 -        WIFI_3V3_EN                             */
#endif
/* } ACER Jen Chang, 2010/04/11*/
    ( GPIO_MODE_MUX1 << (2 * (GPIO_D22 & 0xF)))| /* GPIOD22 -        OVP_EN                                  */
...
/* ACER Jen chang, 2010/04/11, IssueKeys:AU21.B-1, Modify GPIO setting for K2/K3 PR2 { */
#if (defined ACER_K3_PR1)
    ( GPIO_MODE_MUX1 << (2 * (GPIO_D30 & 0xF)))| /* GPIOD30 -        LED_CTRL2                               */
#elif (defined ACER_K3_PR2)
    ( GPIO_MODE_MUX1 << (2 * (GPIO_D30 & 0xF)))| /* GPIOD30 -        BT_2V8_EN                               */
#endif
/* } ACER Jen Chang, 2010/04/11*/
 ...
 },
{
 ...
 },
 {
    ...
    ( GPIO_MODE_MUX1 << (2 * (GPIO_E19 & 0xF)))| /* GPIOE19 -        HWID2                                   */
    ...
    ( GPIO_MODE_MUX1 << (2 * (GPIO_E31 & 0xF)))  /* GPIOE31 -        HWID1                                   */
 },
 {
    ...
    ( GPIO_MODE_MUX1 << (2 * (GPIO_F2  & 0xF)))| /* GPIOF2 -         Band_SEL                                */
    ( GPIO_MODE_MUX0 << (2 * (GPIO_F3  & 0xF)))| /* KCOL5 -          CKCOL5                                  */
    ( GPIO_MODE_MUX0 << (2 * (GPIO_F4  & 0xF)))| /* KCOL6 -          CKCOL6                                  */
    ( GPIO_MODE_MUX1 << (2 * (GPIO_F5  & 0xF)))| /* GPIOF5 -         NC                                      */
    ( GPIO_MODE_MUX0 << (2 * (GPIO_F6  & 0xF)))| /* KROW5 -          KROW5                                   */
    ( GPIO_MODE_MUX0 << (2 * (GPIO_F7  & 0xF)))| /* KROW6 -          KROW6                                   */
/* ACER Jen chang, 2010/04/11, IssueKeys:AU21.B-1, Modify GPIO setting for K2/K3 PR2 { */
#if (defined ACER_K3_PR1)
    ( GPIO_MODE_MUX1 << (2 * (GPIO_F8  & 0xF)))| /* GPIOF8 -         LED_CTRL3                               */
#elif (defined ACER_K3_PR2)
...
/* } ACER Jen Chang, 2010/04/11*/
 ...
 },
 {
    ...
    ( GPIO_MODE_MUX0 << (2 * (GPIO_F18 & 0xF)))  /* NFI_CEn -        NFI_CEn                                 */
 },
 /* Configure PAD Value */
 {
...
struct pnx_gpio_config pnx_gpio_init_config[] = {
  ...
  /* {.gpio = GPIO_A3,    .dir =                ,   .value =  , },*/  /* SD_CARD_DET           */
  ...
  /* {.gpio = GPIO_A6,    .dir = GPIO_DIR_OUTPUT,   .value = 1, },*/  /* LCD_BL_PWM            */
  ...
  /* {.gpio = GPIO_A11,   .dir =                ,   .value =  , },*/  /* BT_UART2_TXD          */
     {.gpio = GPIO_A12,   .dir = GPIO_DIR_OUTPUT,   .value = 0, },    /* IO_INT                */
  ...
  /* {.gpio = GPIO_A22,   .dir =                ,   .value =  , },*/  /* PDNB_2G               */
     ...
     {.gpio = GPIO_A24,   .dir = GPIO_DIR_OUTPUT,   .value = 0, },    /* WLAN_RESETN           */
  /* {.gpio = GPIO_A25,   .dir =                ,   .value =  , },*/  /* TAC_IRQ                */
  ...
  /* {.gpio = GPIO_A28,   .dir =                ,   .value =  , },*/  /* WLAN_SPI_MOSI         */
     {.gpio = GPIO_A29,   .dir = GPIO_DIR_OUTPUT,   .value = 0, },    /* Not Connected         */
  ...
  /* {.gpio = GPIO_B3,    .dir =                ,   .value =  , },*/  /* BT_DCL_CLK             */
     {.gpio = GPIO_B4,    .dir = GPIO_DIR_OUTPUT,   .value = 0, },    /* Not Connected          */
  ...
  /* {.gpio = GPIO_C9,    .dir =                ,   .value =  , },*/  /* VDE_A0_RS              */
     {.gpio = GPIO_C10,   .dir = GPIO_DIR_OUTPUT,   .value = 0, },    /* Not Connected          */
  ...
  /* {.gpio = GPIO_D17,   .dir =                ,   .value =  , },*/  /* WCDMA_PA_ON1           */
     {.gpio = GPIO_D18,   .dir = GPIO_DIR_OUTPUT,   .value = 0, },    /* WLAN_HOST_WAKE         */
     {.gpio = GPIO_D19,   .dir = GPIO_DIR_OUTPUT,   .value = 0, },    /* BT_HOST_WAKE           */
  /* {.gpio = GPIO_D20,   .dir =                ,   .value =  , },*/  /* UART_RXD1              */
/* ACER Jen chang, 2010/04/11, IssueKeys:AU21.B-1, Modify GPIO setting for K2/K3 PR2 { */
#if (defined ACER_K3_PR1)
  /* {.gpio = GPIO_D21,   .dir =                ,   .value =  , },*/  /* LED_CTRL1              */
#elif (defined ACER_K3_PR2)
     {.gpio = GPIO_D21,   .dir = GPIO_DIR_OUTPUT,   .value = 0, },    /* WIFI_3V3_EN            */
#endif
/* } ACER Jen Chang, 2010/04/11*/
     {.gpio = GPIO_D22,   .dir = GPIO_DIR_OUTPUT,   .value = 0, },    /* OVP_EN                 */
...
/* ACER Jen chang, 2010/04/11, IssueKeys:AU21.B-1, Modify GPIO setting for K2/K3 PR2 { */
#if (defined ACER_K3_PR1)
  /* {.gpio = GPIO_D30,   .dir =                ,   .value =  , },*/  /* LED_CTRL2              */
#elif (defined ACER_K3_PR2)
     {.gpio = GPIO_D30,   .dir = GPIO_DIR_OUTPUT,   .value = 0, },    /* BT_2V8_EN              */
#endif
/* } ACER Jen Chang, 2010/04/11*/
  ...
  /*============================================================================================*/
     ...
     {.gpio = GPIO_E19,   .dir = GPIO_DIR_OUTPUT,   .value = 0, },    /* HWID2                  */
     {.gpio = GPIO_E20,   .dir = GPIO_DIR_OUTPUT,   .value = 0, },    /* Not Connected          */
  /* {.gpio = GPIO_E21,   .dir =                ,   .value =  , },*/  /* AGPS_SPI2_DATIO        */
  ...
  /* {.gpio = GPIO_E30,   .dir =                ,   .value =  , },*/  /* ANT_SEL3               */
     {.gpio = GPIO_E31,   .dir = GPIO_DIR_OUTPUT,   .value = 0, },    /* HWID1                  */
  ...
  /*============================================================================================*/
     ...
     {.gpio = GPIO_F2,    .dir = GPIO_DIR_OUTPUT,  .value = 0, },     /* Band_SEL               */
  /* {.gpio = GPIO_F3,    .dir =                ,  .value =  , },*/   /* CKCOL5                 */
  /* {.gpio = GPIO_F4,    .dir =                ,  .value =  , },*/   /* CKCOL6                 */
     {.gpio = GPIO_F5,    .dir = GPIO_DIR_OUTPUT,  .value = 0, },     /* Not Connected          */
  /* {.gpio = GPIO_F6,    .dir =                ,  .value =  , },*/   /* KROW5                  */
  /* {.gpio = GPIO_F7,    .dir =                ,  .value =  , },*/   /* KROW6                  */
/* ACER Jen chang, 2010/04/11, IssueKeys:AU21.B-1, Modify GPIO setting for K2/K3 PR2 { */
#if (defined ACER_K3_PR1)
  /* {.gpio = GPIO_F8,    .dir = GPIO_DIR_OUTPUT,  .value = 0, },*/   /* LED_CTRL3              */
#elif (defined ACER_K3_PR2)
  /* {.gpio = GPIO_F8,    .dir =                ,  .value = 0, },*/   /* NC                     */
#endif
/* } ACER Jen Chang, 2010/04/11*/
