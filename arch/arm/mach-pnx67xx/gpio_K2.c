/*
 *  linux/arch/arm/mach-pnx67xx/gpio_K2.c
 *
...
{
 {
    ...
    ( GPIO_MODE_MUX0 << (2 * (GPIO_A12 & 0xF)))| /* GPIOA12 -        WLAN_HOST_WAKE                          */
    ( GPIO_MODE_MUX0 << (2 * (GPIO_A13 & 0xF)))| /* GPIOA13 -        WLAN_SPI_IRQ                            */
 ...
 },
 {
    ...
    0 |
    ( GPIO_MODE_MUX1 << (2 * (GPIO_A16 & 0xF)))| /* FCIDATA3 -       FCI_DATA3                               */
    ( GPIO_MODE_MUX0 << (2 * (GPIO_A17 & 0xF)))| /* GPIOA17 -        HSDET                                   */
    ( GPIO_MODE_MUX1 << (2 * (GPIO_A18 & 0xF)))| /* FCIDATA2 -       FCI_DATA2                               */
    ( GPIO_MODE_MUX1 << (2 * (GPIO_A19 & 0xF)))| /* FCIDATA1 -       FCI_DATA1                               */
    ( GPIO_MODE_MUX0 << (2 * (GPIO_A20 & 0xF)))| /* GPIOA20 -        WLAN_SPI_CS                             */
    ...
    ( GPIO_MODE_MUX0 << (2 * (GPIO_A24 & 0xF)))| /* GPIOA24 -        NC                                      */
    ( GPIO_MODE_MUX0 << (2 * (GPIO_A25 & 0xF)))| /* GPIOA25 -        TP_IRQ                                  */
    ( GPIO_MODE_MUX0 << (2 * (GPIO_A26 & 0xF)))| /* GPIOA26 -        NC                                      */
    ( GPIO_MODE_MUX1 << (2 * (GPIO_A27 & 0xF)))| /* SCLK1 -          WLAN_SPI_CLK  (SPI1)                    */
    ( GPIO_MODE_MUX1 << (2 * (GPIO_A28 & 0xF)))| /* SDATIO1 -        WLAN_SPI_MOSI (SPI1)                    */
/* ACER Jen chang, 2010/04/11, IssueKeys:AU21.B-1, Modify GPIO setting for K2/K3 PR2 { */
#if (defined ACER_K2_PR1)
    ( GPIO_MODE_MUX0 << (2 * (GPIO_A29 & 0xF)))| /* GPIOA29 -        NC                                      */
#elif (defined ACER_K2_PR2)
    ( GPIO_MODE_MUX0 << (2 * (GPIO_A29 & 0xF)))| /* GPIOA29 -        BKLIGHT_LCD_ON_OFF                      */
#endif
/* } ACER Jen Chang, 2010/04/11*/
    ( GPIO_MODE_MUX0 << (2 * (GPIO_A30 & 0xF)))| /* GPIOA30 -        AGPS_PWR_ON_GPIOA30                     */
    ( GPIO_MODE_MUX2 << (2 * (GPIO_A31 & 0xF)))  /* SDATIN1 -        WLAN_SPI_MISO (SPI1)                    */
 },
 {
    ...
    ( GPIO_MODE_MUX1 << (2 * (GPIO_B4  & 0xF)))| /* GPIOB4 -         WLAN_SHUTDOWN                           */
    ...
    ( GPIO_MODE_MUX0 << (2 * (GPIO_B9  & 0xF)))| /* FCICMD -         FCI_CMD                                 */
    ( GPIO_MODE_MUX0 << (2 * (GPIO_B10 & 0xF)))| /* FCICLK -         FCI_CLK                                 */
    ( GPIO_MODE_MUX0 << (2 * (GPIO_B11 & 0xF)))| /* FCIDATA0 -       FCI_DATA0                               */
 ...
 },
 {
    ...
    0 |
    ( GPIO_MODE_MUX0 << (2 * (GPIO_C0  & 0xF)))| /* VDE_D0 -         VDE_D0                                  */
    ( GPIO_MODE_MUX0 << (2 * (GPIO_C1  & 0xF)))| /* VDE_D1 -         VDE_D1                                  */
    ( GPIO_MODE_MUX0 << (2 * (GPIO_C2  & 0xF)))| /* VDE_D2 -         VDE_D2                                  */
    ( GPIO_MODE_MUX0 << (2 * (GPIO_C3  & 0xF)))| /* VDE_D3 -         VDE_D3                                  */
    ( GPIO_MODE_MUX0 << (2 * (GPIO_C4  & 0xF)))| /* VDE_D4 -         VDE_D4                                  */
    ( GPIO_MODE_MUX0 << (2 * (GPIO_C5  & 0xF)))| /* VDE_D5 -         VDE_D5                                  */
    ( GPIO_MODE_MUX0 << (2 * (GPIO_C6  & 0xF)))| /* VDE_D6 -         VDE_D6                                  */
    ( GPIO_MODE_MUX0 << (2 * (GPIO_C7  & 0xF)))| /* VDE_D7 -         VDE_D7                                  */
    ( GPIO_MODE_MUX0 << (2 * (GPIO_C8  & 0xF)))| /* VDE_D8 -         VDE_D8                                  */
    ( GPIO_MODE_MUX0 << (2 * (GPIO_C9  & 0xF)))| /* VDE_A0 -         VDE_A0_RS                               */
/* ACER Jen chang, 2010/04/11, IssueKeys:AU21.B-1, Modify GPIO setting for K2/K3 PR2 { */
#if (defined ACER_K2_PR1)
    ( GPIO_MODE_MUX1 << (2 * (GPIO_C10 & 0xF)))| /* GPIOC10 -        BKLIGHT_LCD_ON_OFF                      */
#elif (defined ACER_K2_PR2)
    ( GPIO_MODE_MUX1 << (2 * (GPIO_C10 & 0xF)))| /* GPIOC10 -        NC                                      */
#endif
/* } ACER Jen Chang, 2010/04/11*/
 ...
 },
 {
    ...
    ( GPIO_MODE_MUX1 << (2 * (GPIO_C17 & 0xF)))| /* GPIOC17 -        NC                                      */
    ( GPIO_MODE_MUX1 << (2 * (GPIO_C18 & 0xF)))| /* GPIOC18 -        WLAN_RESETN                             */
    ...
    ( GPIO_MODE_MUX1 << (2 * (GPIO_C23 & 0xF)))| /* GPIOC23 -        NC                                      */
    ...
    ( GPIO_MODE_MUX0 << (2 * (GPIO_C30 & 0xF)))| /* SDA2 -           I2C2_SDA                                */
    ( GPIO_MODE_MUX0 << (2 * (GPIO_C31 & 0xF)))  /* SCL2 -           I2C2_SCL                                */
 },
 {
 ...
 },
 {
    ...
    ( GPIO_MODE_MUX1 << (2 * (GPIO_D18 & 0xF)))| /* GPIOD18 -        FCI_DET                                 */
    ( GPIO_MODE_MUX1 << (2 * (GPIO_D19 & 0xF)))| /* GPIOD19 -        NC                                      */
    ( GPIO_MODE_MUX0 << (2 * (GPIO_D20 & 0xF)))| /* RXD1 -           UART_RXD1                               */
    ( GPIO_MODE_MUX0 << (2 * (GPIO_D21 & 0xF)))| /* DIISWS -         NC                                      */
    ( GPIO_MODE_MUX1 << (2 * (GPIO_D22 & 0xF)))| /* GPIOD22 -        OVP_EN_GPIOA17                          */
    ( GPIO_MODE_MUX1 << (2 * (GPIO_D23 & 0xF)))| /* GPIOD23 -        CAM_RST1                                */
    ( GPIO_MODE_MUX1 << (2 * (GPIO_D24 & 0xF)))| /* GPIOD24 -        CHG_SEL_GPIOD24                         */
    ...
    ( GPIO_MODE_MUX0 << (2 * (GPIO_D30 & 0xF)))| /* DISSD1 -         NC                                      */
 ...
 },
{
 ...
 },
 {
    ...
    ( GPIO_MODE_MUX0 << (2 * (GPIO_E21 & 0xF)))| /* SDATO2 -         AGPS_SPI2_DATIO (SPI2)                  */
...
/* ACER Jen chang, 2010/04/11, IssueKeys:AU21.B-1, Modify GPIO setting for K2/K3 PR2 { */
#if (defined ACER_K2_PR1)
    ( GPIO_MODE_MUX1 << (2 * (GPIO_E31 & 0xF)))  /* GPIOE31 -        NC                                      */
#elif (defined ACER_K2_PR2)
    ( GPIO_MODE_MUX1 << (2 * (GPIO_E31 & 0xF)))  /* GPIOE31 -        BT_VCC_ON                               */
#endif
/* } ACER Jen Chang, 2010/04/11*/
 },
 {
    ...
    ( GPIO_MODE_MUX1 << (2 * (GPIO_F2  & 0xF)))| /* GPIOF2 -         FTM                                     */
    ( GPIO_MODE_MUX1 << (2 * (GPIO_F3  & 0xF)))| /* GPIOF3 -         NC                                      */
    ( GPIO_MODE_MUX1 << (2 * (GPIO_F4  & 0xF)))| /* GPIOF4 -         NC                                      */
    ( GPIO_MODE_MUX1 << (2 * (GPIO_F5  & 0xF)))| /* GPIOF5 -         NC                                      */
    ( GPIO_MODE_MUX1 << (2 * (GPIO_F6  & 0xF)))| /* GPIOF6 -         NC                                      */
    ( GPIO_MODE_MUX1 << (2 * (GPIO_F7  & 0xF)))| /* GPIOF7 -         NC                                      */
    ( GPIO_MODE_MUX1 << (2 * (GPIO_F8  & 0xF)))| /* GPIOF8 -         NC                                      */
    ( GPIO_MODE_MUX1 << (2 * (GPIO_F9  & 0xF)))| /* GPIOF9 -         AGPS_RSTn                               */
    ( GPIO_MODE_MUX0 << (2 * (GPIO_F10 & 0xF)))| /* GPIOF10 -        NC                                      */
    ( GPIO_MODE_MUX0 << (2 * (GPIO_F11 & 0xF)))| /* VDE_D9 -         VDE_D_9                                 */
    ( GPIO_MODE_MUX0 << (2 * (GPIO_F12 & 0xF)))| /* VDE_D10 -        VDE_D_10                                */
    ( GPIO_MODE_MUX0 << (2 * (GPIO_F13 & 0xF)))| /* VDE_D11 -        VDE_D_11                                */
    ( GPIO_MODE_MUX0 << (2 * (GPIO_F14 & 0xF)))| /* VDE_D12 -        VDE_D_12                                */
    ( GPIO_MODE_MUX0 << (2 * (GPIO_F15 & 0xF)))  /* VDE_D13 -        VDE_D_13                                */
 },
 {
    (void __iomem*) SCON_SYSMUX11_REG,
    0 |
    ( GPIO_MODE_MUX0 << (2 * (GPIO_F16 & 0xF)))| /* VDE_D14 -        VDE_D_14                                */
    ( GPIO_MODE_MUX0 << (2 * (GPIO_F17 & 0xF)))| /* VDE_D15 -        VDE_D_15                                */
...
struct pnx_gpio_config pnx_gpio_init_config[] = {
  ...
  /* {.gpio = GPIO_A11,   .dir =                ,   .value =  , },*/  /* BT_UART2_TXD          */
     {.gpio = GPIO_A12,   .dir = GPIO_DIR_OUTPUT,   .value = 0, },    /* WLAN_HOST_WAKE        */
     {.gpio = GPIO_A13,   .dir = GPIO_DIR_OUTPUT,   .value = 0, },    /* WLAN_SPI_IRQ          */
  /* {.gpio = GPIO_A14,   .dir =                ,   .value =  , },*/  /* POWER_IRQ             */
  /* {.gpio = GPIO_A15,   .dir =                ,   .value =  , },*/  /* RF_ANT_DET            */
  /* {.gpio = GPIO_A16,   .dir =                ,   .value =  , },*/  /* FCI_DATA3             */
  /* {.gpio = GPIO_A17,   .dir =                ,   .value =  , },*/  /* HSDET                 */
  /* {.gpio = GPIO_A18,   .dir =                ,   .value =  , },*/  /* FCI_DATA2             */
  /* {.gpio = GPIO_A19,   .dir =                ,   .value =  , },*/  /* FCI_DATA1             */
     {.gpio = GPIO_A20,   .dir = GPIO_DIR_OUTPUT,   .value = 0, },    /* WLAN_SPI_CS           */
     {.gpio = GPIO_A21,   .dir = GPIO_DIR_OUTPUT,   .value = 0, },    /* RF3G_REG_ON           */
  /* {.gpio = GPIO_A22,   .dir =                ,   .value =  , },*/  /* PDNB_2G               */
     {.gpio = GPIO_A23,   .dir = GPIO_DIR_OUTPUT,   .value = 0, },    /* RF2G_RESETn           */
     {.gpio = GPIO_A24,   .dir = GPIO_DIR_OUTPUT,   .value = 0, },    /* Not Connected         */
  /* {.gpio = GPIO_A25,   .dir =                ,   .value =  , },*/  /* TP_IRQ                */
     {.gpio = GPIO_A26,   .dir = GPIO_DIR_OUTPUT,   .value = 0, },    /* Not Connected         */
  /* {.gpio = GPIO_A27,   .dir =                ,   .value =  , },*/  /* WLAN_SPI_CLK          */
  /* {.gpio = GPIO_A28,   .dir =                ,   .value =  , },*/  /* WLAN_SPI_MOSI         */
/* ACER Jen chang, 2010/04/11, IssueKeys:AU21.B-1, Modify GPIO setting for K2/K3 PR2 { */
#if (defined ACER_K2_PR1)
  /* {.gpio = GPIO_A29,   .dir =                ,   .value =  , },*/  /* Not Connected         */
#elif (defined ACER_K2_PR2)
  /* Bright Lee, 2010/7/22, Remove this because backlight need speical control during booting { */
  /* {.gpio = GPIO_A29,   .dir = GPIO_DIR_OUTPUT,   .value = 1, },*/  /* BKLIGHT_LCD_ON_OFF	*/
  /* } ACER Bright Lee, 2010/7/22 */
#endif
/* } ACER Jen Chang, 2010/04/11*/
     {.gpio = GPIO_A30,   .dir = GPIO_DIR_OUTPUT,   .value = 0, },    /* AGPS_PWR_ON_GPIOA30   */
  /* {.gpio = GPIO_A31,   .dir =                ,   .value =  , },*/  /* WLAN_SPI_MISO         */
  ...
  /* {.gpio = GPIO_B3,    .dir =                ,   .value =  , },*/  /* BT_DCL_CLK             */
     {.gpio = GPIO_B4,    .dir = GPIO_DIR_OUTPUT,   .value = 0, },    /* WLAN_SHUTDOWN          */
  ...
  /* {.gpio = GPIO_B9,    .dir =                ,   .value =  , },*/  /* FCI_CMD                */
  /* {.gpio = GPIO_B10,   .dir =                ,   .value =  , },*/  /* FCI_CLK                */
  /* {.gpio = GPIO_B11,   .dir =                ,   .value =  , },*/  /* FCI_DATA0              */
  /* {.gpio = GPIO_B12,   .dir =                ,   .value =  , },*/  /* BROADCAST_TX_BLANKING  */
  /* {.gpio = GPIO_B13,   .dir =                ,   .value =  , },*/  /* GSM_PA_BAND_1          */
     {.gpio = GPIO_B14,   .dir = GPIO_DIR_OUTPUT,   .value = 0, },    /* Not Connected          */
...
/* ACER Jen chang, 2010/04/11, IssueKeys:AU21.B-1, Modify GPIO setting for K2/K3 PR2 { */
#if (defined ACER_K2_PR1)
     {.gpio = GPIO_C10,   .dir = GPIO_DIR_OUTPUT,   .value = 1, },    /* BKLIGHT_LCD_ON_OFF     */
#elif (defined ACER_K2_PR2)
  /* {.gpio = GPIO_C10,   .dir =                ,   .value =  , },*/  /* Not Connected          */
#endif
/* } ACER Jen Chang, 2010/04/11*/
  ...
  /* {.gpio = GPIO_C16,   .dir =                ,   .value =  , },*/  /* KCOL2                  */
     {.gpio = GPIO_C17,   .dir = GPIO_DIR_OUTPUT,   .value = 0, },    /* Not Connected          */
     {.gpio = GPIO_C18,   .dir = GPIO_DIR_OUTPUT,   .value = 0, },    /* WLAN_RESETN            */
  /* {.gpio = GPIO_C19,   .dir =                ,   .value =  , },*/  /* KROW0                  */
  /* {.gpio = GPIO_C20,   .dir =                ,   .value =  , },*/  /* KROW1                  */
  /* {.gpio = GPIO_C21,   .dir =                ,   .value =  , },*/  /* KROW2                  */
  /* {.gpio = GPIO_C22,   .dir =                ,   .value =  , },*/  /* KROW3                  */
     {.gpio = GPIO_C23,   .dir = GPIO_DIR_OUTPUT,   .value = 0, },    /* Not Connected          */
  ...
  /* {.gpio = GPIO_C30,   .dir =                ,   .value =  , },*/  /* I2C2_SDA               */
  /* {.gpio = GPIO_C31,   .dir =                ,   .value =  , },*/  /* I2C2_SCL               */
  ...
  /* {.gpio = GPIO_D17,   .dir =                ,   .value =  , },*/  /* WCDMA_PA_ON1           */
     {.gpio = GPIO_D18,   .dir = GPIO_DIR_OUTPUT,   .value = 0, },    /* FCI_DET                */
     {.gpio = GPIO_D19,   .dir = GPIO_DIR_OUTPUT,   .value = 0, },    /* Not Connected          */
  ...
  /* {.gpio = GPIO_D23,   .dir =                ,   .value =  , },*/  /* CAM_RST1               */
     {.gpio = GPIO_D24,   .dir = GPIO_DIR_OUTPUT,   .value = 1, },    /* CHG_SEL_GPIOD24        */
  /* {.gpio = GPIO_D25,   .dir =                ,   .value =  , },*/  /* MODE_SELECT_1          */
  /* {.gpio = GPIO_D26,   .dir =                ,   .value =  , },*/  /* PA_VMODE2_1            */
...
/* ACER Jen chang, 2010/04/11, IssueKeys:AU21.B-1, Modify GPIO setting for K2/K3 PR2 { */
#if (defined ACER_K2_PR1)
  /* {.gpio = GPIO_E31,   .dir =                ,   .value =  , },*/  /* Not Connected          */
#elif (defined ACER_K2_PR2)
     {.gpio = GPIO_E31,   .dir = GPIO_DIR_OUTPUT,   .value = 0, },    /* BT_VCC_ON              */
#endif
/* } ACER Jen Chang, 2010/04/11*/
  ...
  /* {.gpio = GPIO_F2,    .dir =                ,  .value =  , },*/   /* FTM                    */
     {.gpio = GPIO_F3,    .dir = GPIO_DIR_OUTPUT,  .value = 0, },     /* Not Connected          */
     {.gpio = GPIO_F4,    .dir = GPIO_DIR_OUTPUT,  .value = 0, },     /* Not Connected          */
     {.gpio = GPIO_F5,    .dir = GPIO_DIR_OUTPUT,  .value = 0, },     /* Not Connected          */
     {.gpio = GPIO_F6,    .dir = GPIO_DIR_OUTPUT,  .value = 0, },     /* Not Connected          */
     {.gpio = GPIO_F7,    .dir = GPIO_DIR_OUTPUT,  .value = 0, },     /* Not Connected          */
  ...
  /* {.gpio = GPIO_F11,   .dir =                ,  .value =  , },*/   /* VDE_D9                 */
  /* {.gpio = GPIO_F12,   .dir =                ,  .value =  , },*/   /* VDE_D10                */
  /* {.gpio = GPIO_F13,   .dir =                ,  .value =  , },*/   /* VDE_D11                */
  /* {.gpio = GPIO_F14,   .dir =                ,  .value =  , },*/   /* VDE_D12                */
  /* {.gpio = GPIO_F15,   .dir =                ,  .value =  , },*/   /* VDE_D13                */
  /* {.gpio = GPIO_F16,   .dir =                ,  .value =  , },*/   /* VDE_D14                */
  /* {.gpio = GPIO_F17,   .dir =                ,  .value =  , },*/   /* VDE_D15                */
