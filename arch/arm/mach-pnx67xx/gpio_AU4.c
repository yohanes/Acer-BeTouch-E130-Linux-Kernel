/*
 *  linux/arch/arm/mach-pnx67xx/gpio_AU4.c
 *
...
{
 {
    ...
    ( GPIO_MODE_MUX0 << (2 * (GPIO_A13 & 0xF)))| /* GPIOA13 -        NC                                      */
 ...
 },
 {
    ...
    ( GPIO_MODE_MUX0 << (2 * (GPIO_A20 & 0xF)))| /* GPIOA20 -        NC                                      */
    ...
    ( GPIO_MODE_MUX0 << (2 * (GPIO_A27 & 0xF)))| /* GPIOA27 -        NC                                      */
    ( GPIO_MODE_MUX0 << (2 * (GPIO_A28 & 0xF)))| /* GPIOA28 -        NC                                      */
    ( GPIO_MODE_MUX0 << (2 * (GPIO_A29 & 0xF)))| /* GPIOA29 -        CTP_EN(NC)                              */
    ( GPIO_MODE_MUX0 << (2 * (GPIO_A30 & 0xF)))| /* GPIOA30 -        AGPS_PWR_ON_GPIOA30                     */
    ( GPIO_MODE_MUX0 << (2 * (GPIO_A31 & 0xF)))  /* GPIOA31 -        PS_ALS_SET                              */
 },
 {
    ...
    ( GPIO_MODE_MUX1 << (2 * (GPIO_B4  & 0xF)))| /* GPIOB4 -         PS_IR_EN_N                              */
 ...
 },
 {
    ...
    ( GPIO_MODE_MUX1 << (2 * (GPIO_C18 & 0xF)))| /* GPIOC18 -        NC                                      */
 ...
 },
 {
    ...
    ( GPIO_MODE_MUX0 << (2 * (GPIO_D21 & 0xF)))| /* DIISWS -         CTP_CE_GPIOD21(NC)                      */
 ...
 },
{
 ...
 },
 {
    ...
    ( GPIO_MODE_MUX1 << (2 * (GPIO_E21 & 0xF)))| /* SDATIO2 -        AGPS_SPI2_DATIO (SPI2)                  */
    ( GPIO_MODE_MUX1 << (2 * (GPIO_E22 & 0xF)))| /* SDATIN2 -        AGPS_SPI2_DATIN (SPI2)                  */
    ( GPIO_MODE_MUX1 << (2 * (GPIO_E23 & 0xF)))| /* SCLK2 -          AGPS_SPI2_CLK   (SPI2)                  */
    ...
    ( GPIO_MODE_MUX1 << (2 * (GPIO_E31 & 0xF)))  /* GPIOE31 -        CAM_PWRON2                              */
 },
 {
    ...
    ( GPIO_MODE_MUX0 << (2 * (GPIO_F3  & 0xF)))| /* GPIOF3 -         NC                                      */
    ( GPIO_MODE_MUX0 << (2 * (GPIO_F4  & 0xF)))| /* GPIOF4 -         NC                                      */
    ( GPIO_MODE_MUX0 << (2 * (GPIO_F5  & 0xF)))| /* GPIOF5 -         NC                                      */
    ( GPIO_MODE_MUX0 << (2 * (GPIO_F6  & 0xF)))| /* GPIOF6 -         NC                                      */
    ( GPIO_MODE_MUX0 << (2 * (GPIO_F7  & 0xF)))| /* GPIOF7 -         NC                                      */
    ( GPIO_MODE_MUX0 << (2 * (GPIO_F8  & 0xF)))| /* GPIOF8 -         NC                                      */
    ( GPIO_MODE_MUX1 << (2 * (GPIO_F9  & 0xF)))| /* GPIOF9 -         AGPS_RSTn                               */
    ( GPIO_MODE_MUX3 << (2 * (GPIO_F10 & 0xF)))| /* GPIOF10 -        NC                                      */
...
struct pnx_gpio_config pnx_gpio_init_config[] = {
  ...
  /* {.gpio = GPIO_A11,   .dir =                ,   .value =  , },*/  /* BT_UART2_TXD          */
     {.gpio = GPIO_A12,   .dir = GPIO_DIR_OUTPUT,   .value = 0, },    /* OVP_FAULT             */
     {.gpio = GPIO_A13,   .dir = GPIO_DIR_OUTPUT,   .value = 0, },    /* Not Connected         */
  ...
  /* {.gpio = GPIO_A19,   .dir =                ,   .value =  , },*/  /* FCI_DATA1             */
     {.gpio = GPIO_A20,   .dir = GPIO_DIR_OUTPUT,   .value = 0, },    /* Not Connected         */
  ...
  /* {.gpio = GPIO_A25,   .dir =                ,   .value =  , },*/  /* TP_IRQ                */
     ...
     {.gpio = GPIO_A27,   .dir = GPIO_DIR_OUTPUT,   .value = 0, },    /* Not Connected         */
     {.gpio = GPIO_A28,   .dir = GPIO_DIR_OUTPUT,   .value = 0, },    /* Not Connected         */
     {.gpio = GPIO_A29,   .dir = GPIO_DIR_OUTPUT,   .value = 0, },    /* CTP_EN(Not Connected) */
     {.gpio = GPIO_A30,   .dir = GPIO_DIR_OUTPUT,   .value = 0, },    /* AGPS_PWR_ON_GPIOA30   */
     {.gpio = GPIO_A31,   .dir = GPIO_DIR_OUTPUT,   .value = 0, },    /* PS_ALS_SET            */
  ...
  /* {.gpio = GPIO_B3,    .dir =                ,   .value =  , },*/  /* BT_DCL_CLK             */
     {.gpio = GPIO_B4,    .dir = GPIO_DIR_OUTPUT,   .value = 0, },    /* PS_IR_EN_N             */
  ...
  /* {.gpio = GPIO_C16,   .dir =                ,   .value =  , },*/  /* KCOL2                  */
     ...
     {.gpio = GPIO_C18,   .dir = GPIO_DIR_OUTPUT,   .value = 0, },    /* Not Connected          */
  /* {.gpio = GPIO_C19,   .dir =                ,   .value =  , },*/  /* KROW0                  */
  /* {.gpio = GPIO_C20,   .dir =                ,   .value =  , },*/  /* KROW1                  */
  /* {.gpio = GPIO_C21,   .dir =                ,   .value =  , },*/  /* KROW2                  */
     {.gpio = GPIO_C22,   .dir = GPIO_DIR_OUTPUT,   .value = 0, },    /* Not Connected          */
  ...
  /* {.gpio = GPIO_D17,   .dir =                ,   .value =  , },*/  /* WCDMA_PA_ON1           */
     ...
     {.gpio = GPIO_D19,   .dir = GPIO_DIR_OUTPUT,   .value = 0, },    /* PS_INT                 */
  /* {.gpio = GPIO_D20,   .dir =                ,   .value =  , },*/  /* UART_RXD1              */
     {.gpio = GPIO_D21,   .dir = GPIO_DIR_OUTPUT,   .value = 0, },    /* CTP_CE_GPIOD21         */
