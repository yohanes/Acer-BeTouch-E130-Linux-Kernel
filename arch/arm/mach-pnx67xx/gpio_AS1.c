 ...
 *
 **********************************************************************/
/* ACER Jen chang, 2010/05/05, IssueKeys:, add ACER gpio mux setting { */
...
struct pnx_scon_config pnx_scon_init_config[ SCON_REGISTER_NB] =
{
 ...
 },
 {
    ...
    ( GPIO_MODE_MUX0 << (2 * (GPIO_A25 & 0xF)))| /* GPIOA25 -        CTP_INT                                  */
 ...
 },
 {
    ...
    ( GPIO_MODE_MUX0 << (2 * (GPIO_C14 & 0xF)))| /* GPIOC14 -        NC                                      */
 ...
 },
 {
    ...
    ( GPIO_MODE_MUX1 << (2 * (GPIO_C20 & 0xF)))| /* GPIOC20 -        NC                                      */
    ( GPIO_MODE_MUX0 << (2 * (GPIO_C21 & 0xF)))| /* KROW2 -          KROW2                                   */
    ( GPIO_MODE_MUX1 << (2 * (GPIO_C22 & 0xF)))| /* GPIOC22 -        NC                                      */
 ...
 },
 {
    ...
    ( GPIO_MODE_MUX1 << (2 * (GPIO_D19 & 0xF)))| /* GPIOD19 -        PS_INT                                  */
 ...
 },
{
 ...
 },
 {
    ...
    ( GPIO_MODE_MUX1 << (2 * (GPIO_F4  & 0xF)))| /* GPIOF4 -         SPK_AMP_SHUTDOWN                        */
...
struct pnx_gpio_config pnx_gpio_init_config[] = {
  ...
  /* {.gpio = GPIO_D19,   .dir =                ,   .value =  , },    /* PS_INT                 */
  ...
  /* {.gpio = GPIO_F2,    .dir =                ,  .value =  , },*/   /* FTM                    */
     ...
     {.gpio = GPIO_F4,    .dir = GPIO_DIR_OUTPUT,  .value = 1, },     /* SPK_AMP_SHUTDOWN       */
