/*
 *  linux/arch/arm/mach-pnx67xx/gpio_AU2.c
 *
...
struct pnx_scon_config pnx_scon_init_config[ SCON_REGISTER_NB] =
{
 ...
 ( GPIO_MODE_MUX1 << (2 * (GPIO_A6  & 0xF)))| /* PWM1 -           LCD_BL_PWM                              */
 ...
 ( GPIO_MODE_MUX0 << (2 * (GPIO_A12 & 0xF)))| /* GPIOA12 -        TRACKBALL_SELECT                        */
 ( GPIO_MODE_MUX0 << (2 * (GPIO_A13 & 0xF)))| /* GPIOA13 -        JOG_BALL_D                              */
 ...
 ( GPIO_MODE_MUX0 << (2 * (GPIO_A20 & 0xF)))| /* GPIOA20 -        JOG_BALL_L                              */
 ...
 ( GPIO_MODE_MUX0 << (2 * (GPIO_A31 & 0xF)))  /* GPIOA31 -        NC                                      */
 },
 {
 (void __iomem*) SCON_SYSMUX2_REG,
 0 |
 ( GPIO_MODE_MUX0 << (2 * (GPIO_B0  & 0xF)))| /* DO -             BT_DD_OUT                               */
 ...
 ( GPIO_MODE_MUX1 << (2 * (GPIO_D18 & 0xF)))| /* GPIOD18 -        JOG_BALL_U                              */
 ( GPIO_MODE_MUX1 << (2 * (GPIO_D19 & 0xF)))| /* GPIOD19 -        JOG_BALL_R                              */
 ...
 },
{
 ...
 ( GPIO_MODE_MUX1 << (2 * (GPIO_F5  & 0xF)))| /* GPIOF5 -         LED_CTRL4                               */
 ...
 ( GPIO_MODE_MUX0 << (2 * (GPIO_F18 & 0xF)))  /* NFI_CE_n -       NFI_CE_n                                */
 },
 /* Configure PAD Value */
 {
...
struct pnx_gpio_config pnx_gpio_init_config[] = {
  ...
  /* {.gpio = GPIO_A12,   .dir =                ,   .value =  , },*/  /* TRACKBALL_SELECT      */
  /* {.gpio = GPIO_A13,   .dir =                ,   .value =  , },*/  /* JOG_BALL_D            */
  ...
  /* {.gpio = GPIO_A20,   .dir =                ,   .value =  , },*/  /* JOG_BALL_L            */
  ...
  /* {.gpio = GPIO_A25,   .dir =                ,   .value =  , },*/  /* TP_IRQ                */
     ...
     {.gpio = GPIO_A31,   .dir = GPIO_DIR_OUTPUT,   .value = 0, },    /* Not Connected         */
  ...
  /* {.gpio = GPIO_D18,   .dir =                ,   .value =  , },*/  /* JOG_BALL_U             */
  /* {.gpio = GPIO_D19,   .dir =                ,   .value =  , },*/  /* JOG_BALL_R             */
  ...
  /* {.gpio = GPIO_D23,   .dir =                ,   .value =  , },*/  /* CAM_RESET1             */
     {.gpio = GPIO_D24,   .dir = GPIO_DIR_OUTPUT,   .value = 0, },    /* CCSET_SEL              */
  ...
  /* {.gpio = GPIO_F5,    .dir =                ,  .value =  , },*/   /* LED_CTRL4              */
